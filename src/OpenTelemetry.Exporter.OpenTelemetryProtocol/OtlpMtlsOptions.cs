...
internal sealed class OtlpMtlsOptions : OtlpTlsOptions
{
    ...
    /// </summary>
    /// <remarks>
    /// This is an alias for <see cref="OtlpTlsOptions.TrustedCertificatePath"/> for backward compatibility.
    /// Corresponds to the OTEL_EXPORTER_OTLP_CERTIFICATE environment variable.
    /// </remarks>
    public string? CaCertificatePath
    {
        get => this.TrustedCertificatePath;
        set => this.TrustedCertificatePath = value;
    }
    ...
    /// Note: Having only <see cref="CaCertificatePath"/> does not constitute mTLS.
    /// </remarks>
    ...
    /// TLS is considered enabled if at least the client certificate path or CA certificate path is provided.
    /// </summary>
    /// <remarks>
    /// For backward compatibility, this returns true if either client cert or CA cert is configured.
    /// </remarks>
