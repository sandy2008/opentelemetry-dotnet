...
/// </summary>
/// <remarks>
/// The <see cref="TrustedCertificatePath"/> option enables trust of server certificates
...
{
    /// <summary>
    /// Gets or sets the path to the trusted CA certificate file in PEM format.
    /// </summary>
    /// <remarks>
    ...
    public virtual bool IsTlsEnabled =>
        !string.IsNullOrWhiteSpace(this.TrustedCertificatePath);
    ...
    /// Server certificate trust alone (TrustedCertificatePath) does not constitute mTLS.
    /// </remarks>
