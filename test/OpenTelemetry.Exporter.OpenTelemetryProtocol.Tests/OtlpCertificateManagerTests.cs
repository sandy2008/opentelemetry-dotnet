...
-----END CERTIFICATE-----";
    ...
    public void LoadCaCertificate_ThrowsFileNotFoundException_WhenTrustStoreFileDoesNotExist()
    {
        ...
        // The underlying manager now uses "Trusted certificate" terminology
        Assert.Contains("Trusted certificate file not found", exception.Message, StringComparison.OrdinalIgnoreCase);
